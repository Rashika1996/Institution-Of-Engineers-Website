...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<link rel="stylesheet" href="layout/styles/ExecutiveCommitee.css" type="text/css" />
</head>
<body id="top">
<div class="wrapper row1">
  <div id="header" class="clear">
   <div class="fl_left">
	<div class="Rimage">
   <a href="pages/images/logo.png"><img src="pages/images/logo.png" height=120px width=120px /></a>
    </div>
	<div class="Rtitle">
     <h1><a href="pages/index.html">Institution of Engineers(India)</a></h1>
    ...
    <form action="#" method="post" id="login">
      <fieldset>
        ...
        <input type="image" src="pages/sign_in.gif" id="signin" alt="Admin Sign In" />
      </fieldset>
    </form>
  </div>
</div>
...
<div class="wrapper row4">
  <div id="container" class="clear"> 
    <!-- ####################################################################################################### -->
    <div id="content">
     <div class="RTitle">Executive Commitee 2015-16</div><br />  
...
<%
		try
	{
	 ...
	 rs=st.executeQuery("select * from EXECommitee");
	 int Snum=0;
	 String image="",name="",MEMID="",Add="",Contact="",Email="",year="";
	 while(rs.next())
	 {
		 Snum=rs.getInt(1);
