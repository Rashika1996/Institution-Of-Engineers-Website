...
<div class="wrapper row4">
  <div id="container" class="clear"> 
    <!-- ####################################################################################################### -->
	   ...
	   <div id="content">
      <div class="RTitle">Chairman 2015-16</div><br />
	 ...
	 rs=st.executeQuery("select * from Chairman where current='present'"); 
	 ...
	 while(rs.next())
	 {
	   ...
	   residencecontact=rs.getString(7);
		...
		%>
		  ...
		  <%  
		 rs=st1.executeQuery("select * from Chairman where current='past'");
		  while(rs.next())
	 {
	   name=rs.getString(1);
	   id=rs.getString(2);
