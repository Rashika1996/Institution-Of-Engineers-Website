...
<link rel="stylesheet" href="layout/styles/NewsUpdate.css" type="text/css" />
</head>
<body id="top">
<div class="wrapper row1">
  <div id="header" class="clear">
   ...
   <a href="images/logo.png"><img src="images/logo.png" height=120px width=120px /></a>
    ...
    <form action="Admin.html" method="post" id="login">
      <fieldset>
    ...
    <div id="content">
      ...
      <div id="respond">
        <form action="InsertNews.jsp" method="post">
           <textarea  id="comment"  cols="100%" rows="10" name="t1"></textarea>
